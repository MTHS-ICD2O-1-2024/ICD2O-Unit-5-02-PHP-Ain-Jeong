...
<head>
  ...
  <meta
    name="description"
    content="Random Positive or Negative Number, with PHP" />
  ...
  <title>Random Positive or Negative Number, with PHP</title>
</head>
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header">
      <div class="mdl-layout__header-row">
        <span class="mdl-layout-title">Random Positive or Negative Number, with PHP</span>
      </div>
    </header>
